...
```
bash -c "$(wget -qO- https://raw.githubusercontent.com/ezlp/1clickxray/main/install.sh)"
```
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ezlp/1clickxray/main/install.sh)"
```


**Link Instalasi Opsi 2**
```
bash -c "$(wget -qO- https://raw.githubusercontent.com/ezlp/1clickxray/main/install2.sh)"
```
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ezlp/1clickxray/main/install2.sh)"
```
