...
apt install python3-psutil python3-pandas python3-tabulate python3-rich python3-distro python3-requests python3-pycountry python3-geoip2 -y
pip install py-cpuinfo --break-system-packages # Temporary
check_success
sleep 1
